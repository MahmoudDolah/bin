...
kitty --hold --title="batterywidget" -e sh -c 'echo "" && tput civis && PS1="" && stty -echo && printf "\033[1mpercentage: \033[0m" && upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep -E "percent" | xargs | sed -z "s/percentage: //g" && printf "\033[1mstate: \033[0m" && upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep -E "state" | xargs | sed -z "s/state: //g" && printf "\033[1mtime to empty: \033[0m" && upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep -E "time" | xargs | sed -z "s/time to empty: //g" && tput cuu 1' &

sleep 0.25

i3-msg [title="batterywidget"] focus, floating enable, resize set 220 110, move position 878 33, border pixel 2
